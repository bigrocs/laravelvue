...
class MenuTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('menus')->insert([
            ...
            'api_route'    => 'api.admin.system.model',
            'icon' 		=> 'fa fa-wrench',
            'target' 	=> '',
            'sort' 		=> 1,
            'status' 	=> 1,
        ...
        DB::table('menus')->insert([
            ...
            'api_route'    => 'api.admin.system.addon',
            'icon' 		=> 'fa fa-cogs',
            'target' 	=> '',
            'sort' 		=> 1,
            'status' 	=> 1,
        ...
        DB::table('menus')->insert([
            ...
            'api_route'    => 'api.admin.system.theme',
            'icon' 		=> 'fa fa-adjust',
            'target' 	=> '',
            'sort' 		=> 1,
            'status' 	=> 1,
        ...
        DB::table('menus')->insert([
            ...
            'api_route'    => 'api.admin.system.user',
            'icon' 		=> 'fa fa-user',
            'target' 	=> '',
            'sort' 		=> 1,
            'status' 	=> 1,
        ...
        DB::table('menus')->insert([
            ...
            'api_route'    => 'api.admin.system.role',
            'icon' 		=> 'fa fa-group',
            'target' 	=> '',
            'sort' 		=> 1,
            'status' 	=> 1,
        ...
        DB::table('menus')->insert([
            ...
            'api_route'    => 'api.admin.system.permission',
            'icon' 		=> 'fa fa-unlock',
            'target' 	=> '',
            'sort' 		=> 1,
            'status' 	=> 1,
